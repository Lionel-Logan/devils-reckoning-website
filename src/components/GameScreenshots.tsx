      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="section-title">
            <GlitchText text="Screenshots & Media" />
          </h2>
        ...
        <div className="relative max-w-5xl mx-auto">
          {/* Main Image Display */}
          <div className="relative rounded-2xl overflow-hidden shadow-dark group">
            <img 
            ...
            {/* Animated Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent animate-pulse-glow" />
            ...
            <Button
              ...
              size="icon"
              onClick={prevSlide}
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-background/20 backdrop-blur-sm border-border hover:bg-background/40 hover:scale-110 transition-all duration-300"
            >
            ...
            <Button
              ...
              size="icon"
              onClick={nextSlide}
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-background/20 backdrop-blur-sm border-border hover:bg-background/40 hover:scale-110 transition-all duration-300"
            >
              <ChevronRight className="h-5 w-5" />
            </Button>
            
            <div className="absolute bottom-6 left-6 right-6">
              <h3 className="text-2xl font-bold text-foreground mb-2 font-accent animate-fade-in-up">
              ...
              <button
                ...
                className={`relative rounded-lg overflow-hidden transition-all duration-300 ${
                  currentSlide === index 
                    ...
                    : 'hover:scale-105 opacity-70 hover:opacity-100 hover:shadow-primary'
                }`}
              >
                <img 
                  src={item.src}
                  alt={item.title}
                  className="w-24 h-14 object-cover transition-transform duration-300 hover:scale-110"
                />
              </button>
            ))}
          </div>
        ...
        <div id="trailer" className="mt-20 text-center">
          <div className="atmospheric-card max-w-2xl mx-auto p-8 hover:shadow-glow transition-all duration-500">
            <h3 className="text-3xl font-bold text-foreground mb-4 font-accent">Official Trailer</h3>
